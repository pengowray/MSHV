...
int GenFt8::genft8(QString str_mam,int *t_iwave,double samp_rate,double f_tx)//,int i3bit
{ 
    int nwave = 0;
    int k1 =0;
    int i3bit = 0;
    ...
    QStringList SlMsgs; //qDebug()<<str_mam<<str_mam.count();
    ...
    for (int z = 0; z < k1; ++z)
        t_iwave[z]=(int)(8380000.0*(d_iwave[z]/(double)nslots));//2.70 24-bit=8380000.0 full=8388607 //28-bit=134080000
